...
namespace FinalProject_C183027.view
{
    public partial class typeWiseReport : System.Web.UI.Page
    {
        ...
        protected void showButton_Click(object sender, EventArgs e)
        {
            ...
            typeWiseReportGridView.DataSource = aReportManager.GetTypeWiseReportView(fromDateInput.Text, toDateInput.Text);
        ...
        protected void pdfButton_Click(object sender, EventArgs e)
        {
            ...
            pdfDocument.Open();
            pdfDocument.Add(aPdfManager.GetTypeWiseReportPdfParagraph(fromDateInput.Text, toDateInput.Text, typeWiseReportGridView, totalInput.Text));
            pdfDocument.Close();
